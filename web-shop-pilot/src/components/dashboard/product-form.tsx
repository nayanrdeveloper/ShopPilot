...
const CREATE_PRODUCT = gql`
  mutation CreateProduct($name: String!, $price: Float!, $sku: String!, $storeId: String!, $stock: Int, $description: String, $imageUrl: String) {
    createProduct(name: $name, price: $price, sku: $sku, storeId: $storeId, stock: $stock, description: $description, imageUrl: $imageUrl) {
      id
    }
  }
`;
                            ...
                            <FormItem>
                                <div className="flex items-center justify-between">
                                    ...
                                    <Button
                                        ...
                                        variant="ghost"
                                        size="sm"
                                        className="h-8 text-purple-600 hover:text-purple-700 hover:bg-purple-100 dark:hover:bg-purple-900/20"
                                        onClick={handleAI}
                                        disabled={aiLoading}
                                    >
